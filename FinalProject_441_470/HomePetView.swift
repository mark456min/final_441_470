...
struct HomePetView: View {
    // เปลี่ยนจาก @StateObject เป็น @EnvironmentObject
    ...
    var body: some View {
        ZStack {
            ...
            // สิ่งสำคัญ: ต้องเติม environmentObject ให้ Preview ไม่งั้นพรีวิวจะพัง
#Preview {
    HomePetView().environmentObject(WeatherViewModel())
}
